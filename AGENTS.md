...
- 用户完成公网测试后，终止 AWS 实例 `i-0a23b365d8517d699` 并清理安全组 `sg-06d20438196dca6f6` 与 S3 部署包 `colorroi-deploy-553432479592-ap-east-1/colorroi-deploy.zip`，避免持续计费。
